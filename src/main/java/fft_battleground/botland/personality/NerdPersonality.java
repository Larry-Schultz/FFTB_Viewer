...
public class NerdPersonality extends PersonalityModule {
	...
	static {
		PersonalityMatrixEntry[] entries = new PersonalityMatrixEntry[] {
				...
				new PersonalityMatrixEntry(3, 10, "Man these teams are super close.  Betting the minimum", false),
				new PersonalityMatrixEntry(10, 25, 
						map -> new StringBuilder("These teams are pretty closesly matched. The ").append(map.get(PersonalityDisplayFields.WINNING_TEAM_PROPER))
							...
							.append(".").toString(), 
						false, 
						new PersonalityDisplayFields[] {PersonalityDisplayFields.WINNING_TEAM_PROPER, PersonalityDisplayFields.WINNING_SCORE, PersonalityDisplayFields.LOSING_TEAM_PROPER, PersonalityDisplayFields.LOSING_SCORE}
				),
				new PersonalityMatrixEntry(26, 75, 
					map -> new StringBuilder("Betting on ").append(map.get(PersonalityDisplayFields.WINNING_TEAM_PROPER)).append(" as it has the higher score ")
						.append(map.get(PersonalityDisplayFields.WINNING_SCORE)).append(" vs ").append(map.get(PersonalityDisplayFields.LOSING_SCORE)).toString(),
					false, 
					new PersonalityDisplayFields[] {PersonalityDisplayFields.WINNING_TEAM_PROPER, PersonalityDisplayFields.WINNING_SCORE, PersonalityDisplayFields.LOSING_SCORE}
				),
				new PersonalityMatrixEntry(76, 98,
					map -> new StringBuilder("The ").append(map.get(PersonalityDisplayFields.WINNING_TEAM_PROPER)).append(" is beating the ").append(map.get(PersonalityDisplayFields.LOSING_TEAM_PROPER))
						.append(" by over ").append(map.get(PersonalityDisplayFields.DIFFERENCE)).append(" points! That is in the ").append(map.get(PersonalityDisplayFields.PERCENTILE))
				...
				new PersonalityMatrixEntry(98, 100,
					map -> new StringBuilder("You should all in.  My data suggests the ").append(map.get(PersonalityDisplayFields.WINNING_TEAM_PROPER)).append(" has over a 98% chance to win!")
						.toString(),
					true,
					new PersonalityDisplayFields[] {PersonalityDisplayFields.WINNING_TEAM_PROPER}
				)
