...
public class PortraitsPageController extends AbstractHomeController {

	private static final String PAGE_NAME = "portraits";
	
	@Autowired
	public PortraitsPageController(AccessTracker accessTracker) {
		super(accessTracker);
	}
