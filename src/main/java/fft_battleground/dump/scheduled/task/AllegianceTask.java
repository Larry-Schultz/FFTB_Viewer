...
@Slf4j
public class AllegianceTask extends DumpScheduledTask {
	...
	public AllegianceTask(DumpScheduledTasks dumpScheduledTasks) { 
	...
	private  void updateAllegiances() {
		...
		playerNamesSet = this.dumpScheduledTasksRef.filterPlayerListToActiveUsers(playerNamesSet, allegiancePreviousBatchDataEntry);
